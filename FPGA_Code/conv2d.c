...
// #pragma HLS UNROLL
                        mult_result[0][HIGH_KER_SQR_INDX-i-k] = 0;
                    }
                }
            } else {
...
#pragma HLS UNROLL
            ...
            hold[KERNEL_DIM_1][0] = delay_line[KERNEL_DIM_1-1][0] + mult_result[0][mult_indx];
...
#pragma HLS UNROLL
                ...
                advance_delay_line(delay_line[hold_indx1], insert_delay[hold_indx1], hold_indx1, delay_end);
                mult_indx--;
                for (hold_indx2 = KERNEL_DIM_2; hold_indx2 > 0; hold_indx2--) {
#pragma HLS UNROLL
                ...
                hold[hold_indx1][0] = delay_line[hold_indx1-1][0] + mult_result[0][mult_indx];
            }

            mult_indx--;
            insert_delay[0] = hold[0][KERNEL_DIM_2] + mult_result[0][mult_indx];
            advance_delay_line(delay_line[0], insert_delay[0], 0, delay_end);
            mult_indx--;
            for (hold_indx2 = KERNEL_DIM_2; hold_indx2 > 0; hold_indx2--) {
#pragma HLS UNROLL
...
#pragma HLS UNROLL
            ...
            hold_indx1--;
            advance_delay_line(delay_line[flush_amnt], hold[hold_indx1][KERNEL_DIM_2], flush_amnt, delay_end);
        }
        for (hold_indx2 = KERNEL_DIM_2; hold_indx2 > 0; hold_indx2--) {
#pragma HLS UNROLL
            hold[hold_indx1][hold_indx2] = hold[hold_indx1][hold_indx2-1];
